...
const AdminProfile = () => {
  ...
  const role = user?.role || savedRole || "admin";
  ...
  return (
    <div className="max-w-5xl mx-auto space-y-6 px-1">
      <div className="bg-white border border-amber-200 rounded-2xl shadow-sm overflow-hidden">
        <div className="h-28 sm:h-32 bg-gradient-to-r from-amber-500 via-yellow-500 to-orange-500" />
      ...
      <div className="bg-white border border-amber-200 rounded-2xl shadow-sm p-5 sm:p-6">
        ...
        <p className="text-sm text-amber-700 mt-1">Your admin account details.</p>
